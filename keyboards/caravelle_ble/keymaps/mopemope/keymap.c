...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ...
  [MISCL] = LAYOUT( // OK
 //+--------+--------+--------+--------+--------+--------+                        +--------+--------+--------+--------+--------+--------+
    AD_WO_L, _____,   _____,   KUP,     _____,   WRKSP1,                           UWRKSP,  PGDN,    GU,      PGUP,    DEL,     _____,   \
 //|--------+--------+--------+--------+--------+--------+--------+      +--------+--------+--------+--------+--------+--------+--------|
    DELBNDS, _____,   KLEFT,   KDOWN,   KRIGHT,  WRKSP2,   CAF2,          PSCR,    DWRKSP,  GL,      GD,      GR,      _____,   _____,   \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
    ENT_DFU, _____,   _____,   COPY,    PASTE,   GUI,      CAF7,          BATT_LV, BTN1,    BTN2,    PSCR,    GH,      _____,   _____,   \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
                               _____,   _____,   _____,    _____,          _____,  _____,   _____,   _____  \
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ),
  [MISCR] = LAYOUT( // OK
 //+--------+--------+--------+--------+--------+--------+                        +--------+--------+--------+--------+--------+--------+
    _____,   _____,   _____,   _____,   _____,   _____,                            PREVTB,  PGDN,    KUP,     PGUP,    DEL,     _____,   \
 //|--------+--------+--------+--------+--------+--------+--------+      +--------+--------+--------+--------+--------+--------+--------|
    _____,   TAB,     _____,   _____,   _____,   _____,   PSCR,           _____,   NEXTTB,  KLEFT,   KDOWN,   KRIGHT,  _____,   DELBNDS, \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
    _____,   _____,   _____,   _____,   _____,   _____,   BATT_LV,        _____,   _____,   _____,   _____,   _____,   _____,   ENT_DFU, \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
                               _____,   _____,   _____,   _____,          _____,   _____,   _____,   _____   \
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ),
 ...
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ...
  [COMBT] = LAYOUT( // OK
 //+--------+--------+--------+--------+--------+--------+                        +--------+--------+--------+--------+--------+--------+
    _____,   _____,   _____,   AD_WO_L, ADV_ID0, ADV_ID1,                          DQT,     EXLM,    PLUS,    ASTR,    PIPE,    _____,   \
 //|--------+--------+--------+--------+--------+--------+--------+      +--------+--------+--------+--------+--------+--------+--------|
    _____,   _____,   _____,   _____,   DEL_ID0, DEL_ID1, ENT_DFU,        _____,   TILD,    EQL,     COLN,    SCLN,    AT,      _____,   \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
    _____,   _____,   _____,   _____,   _____,   _____,   ENT_SLP,        _____,   _____,   MINS,    COMM,    DOT,     SLSH,    _____,   \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
                               _____,   _____,   _____,   _____,          _____,   _____,   _____,   _____   \
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ),
