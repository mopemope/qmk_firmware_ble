...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ...
  [MISCR] = LAYOUT( // OK
 //+--------+--------+--------+--------+--------+--------+                        +--------+--------+--------+--------+--------+--------+
    _____,   _____,   _____,   _____,   _____,   _____,                            PREVTB,  PGDN,    KUP,     PGUP,    DEL,     ENT_DFU, \
 //|--------+--------+--------+--------+--------+--------+--------+      +--------+--------+--------+--------+--------+--------+--------|
    _____,   TAB,     _____,   _____,   _____,   _____,   PSCR,           _____,   NEXTTB,  KLEFT,   KDOWN,   KRIGHT,  _____,   DELBNDS, \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
    _____,   _____,   _____,   _____,   _____,   _____,   BATT_LV,        _____,   _____,   _____,   _____,   _____,   _____,   ENT_SLP, \
 //|--------+--------+--------+--------+--------+--------+--------|      |--------+--------+--------+--------+--------+--------+--------|
                               _____,   _____,   _____,   _____,          _____,   _____,   _____,   _____   \
 //                           +--------+--------+--------+--------+      +--------+--------+--------+--------+
  ),
